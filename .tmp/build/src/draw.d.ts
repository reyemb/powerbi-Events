...
export declare class DrawEvents {
     ...
     */
    drawBoxes(data: IDataPoint[]): void;
    drawRect(startTime: Date, endTime: Date, deviceId: string, event: string, color: string, dataPoints: IDataPoint[]): void;
